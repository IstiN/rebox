...
Create an [npm access token](https://docs.npmjs.com/creating-and-viewing-access-tokens) (Automation or Publish). Add it as **`NPM_TOKEN`** in GitHub Actions secrets. Use workflow **Publish to npm** (manual or on release).
